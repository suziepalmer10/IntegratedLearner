...
#' make predictions from an 'IntegratedLearner' object
#'
#'@description This functions makes predictions from an IntegratedLearner object for new samples for which predictions are to be made
#'
