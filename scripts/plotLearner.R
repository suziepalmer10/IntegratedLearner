...
#' @param rowwise If both train and test data is available, should the train and test plots be rowwise. Default is TRUE. If FALSE, plots are aligned column-wise.
#'
#' @return
#' @export
#'
